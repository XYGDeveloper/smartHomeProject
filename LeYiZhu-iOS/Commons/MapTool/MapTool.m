...
- (void)appleNaiWithCoordinate:(CLLocationCoordinate2D)coordinate andWithMapTitle:(NSString *)map_title{
    ...
    CLLocationCoordinate2D converte_gps = [JZLocationConverter bd09ToGcj02:coordinate];
...
- (void)aNaviWithCoordinate:(CLLocationCoordinate2D)coordinate andWithMapTitle:(NSString *)map_title{
    CLLocationCoordinate2D converte_gps = [JZLocationConverter bd09ToWgs84:coordinate];
    NSString *urlsting =[[NSString stringWithFormat:@"iosamap://navi?sourceApplication=乐易住&poiname=&poiid=BGVIS&lat=%f&lon=%f&dev=1&style=2",converte_gps.latitude,converte_gps.longitude]stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
