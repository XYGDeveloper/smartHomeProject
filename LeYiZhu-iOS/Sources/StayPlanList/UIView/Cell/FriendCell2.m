...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.label.textColor = [UIColor colorWithRed:102/255.0f green:102/255.0f  blue:102/255.0f  alpha:1.0f];
...
#pragma mark - friendCircleImageView每部已经自动自动计算高度
    ...
    [self.bgview mas_updateConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.commentCount.mas_bottom).mas_equalTo(4);
...
- (void)cellDataWithModel:(HotelCommentsModel *)model
{
    ...
    self.label.text = [NSString stringWithFormat:@"回复:%@",model.reply];
