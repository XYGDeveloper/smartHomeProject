...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.layer.borderColor = _tagAttribute.normalBOrdergroundColor.CGColor;
    cell.layer.cornerRadius = _tagAttribute.cornerRadius;
    cell.layer.borderWidth = _tagAttribute.borderWidth;
    cell.titleLabel.textColor = _tagAttribute.normaltextgroundColor;
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        ...
        cell.layer.borderColor = _tagAttribute.selectedOrdergroundColor.CGColor;
        cell.titleLabel.textColor = _tagAttribute.selectetextgroundColor;
    }
