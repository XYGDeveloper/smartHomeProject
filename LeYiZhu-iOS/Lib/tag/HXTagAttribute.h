...
@property (nonatomic,strong) UIColor *normalBOrdergroundColor;//标签默认背景颜色
@property (nonatomic,strong) UIColor *selectedOrdergroundColor;//标签选中背景颜色
@property (nonatomic,strong) UIColor *normaltextgroundColor;//标签默认背景颜色
@property (nonatomic,strong) UIColor *selectetextgroundColor;//标签选中背景颜色
