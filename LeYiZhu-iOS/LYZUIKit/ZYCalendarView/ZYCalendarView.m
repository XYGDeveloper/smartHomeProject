...
+ (void)displayCalederViewWithTitle:(NSString *)title inViewController:(UIViewController *)viewcontroller
{

    ZYCalendarView *calederView = [[ZYCalendarView alloc]initWithFrame:[UIApplication sharedApplication].keyWindow.bounds];
    calederView.presentViewController = viewcontroller;
...
//        [self addSubview:monthView5];
        ...
        self.contentSize = CGSizeMake(size.width, monthView1.frame.size.height + monthView2.frame.size.height + monthView3.frame.size.height);
...
//    ZYMonthView *tmpView = monthView5;
     ZYMonthView *tmpView = monthView3;
...
//    monthView5.date = [self.manager.helper addToDate:monthView4.date months:1];
    monthView3 = tmpView;
    monthView3.date = [self.manager.helper addToDate:monthView2.date months:1];
...
//                                  monthView1.frame.size.height + monthView2.frame.size.height + monthView3.frame.size.height + monthView4.frame.size.height + monthView5.frame.size.height);
    self.contentSize = CGSizeMake(size.width,
                                  monthView1.frame.size.height + monthView2.frame.size.height + monthView3.frame.size.height);
}
